      ...
      {loading ? (
        ...
        >
          ...
          <p style={{ fontSize: 13, color: "#9CA3AF", marginTop: 6 }}>
            Tailor your resume on the Dashboard, then click "Save Version" on the Results page.
          </p>
        </div>
      ) : (
        <div
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    {selected.improved_bullets.map((bullet, i) => (
                      ...
                      >
                        ...
                        >
                          <p style={{ fontSize: 11, fontWeight: 600, color: "#9CA3AF", margin: "0 0 4px 0" }}>
                            ORIGINAL
                          </p>
                        ...
                        <div style={{ padding: "10px 14px", background: "#FFFFFF" }}>
                          <p style={{ fontSize: 11, fontWeight: 600, color: "#16A34A", margin: "0 0 4px 0" }}>
                            IMPROVED
                          </p>
